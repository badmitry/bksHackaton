...
import com.badmitry.bkshackaton.databinding.SubFragmentProfitabilityBinding
...
class SubFragmentProfitability : BaseFragment() {
    private lateinit var binding: SubFragmentProfitabilityBinding
    private lateinit var viewModel: SubFragmentProfitabilityViewModel
...
//        viewModel.saveCurrentScreen(finances)
    ...
    override fun onCreateView(
        ...
        binding = SubFragmentProfitabilityBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun initViewModel() {
        viewModel =
            ViewModelProvider(this, vmFactory)[SubFragmentProfitabilityViewModel::class.java]
